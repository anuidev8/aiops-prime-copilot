...
export const AIOPS_COORDINATOR_INSTRUCTION = [
  ...
  "UI TOOLS (CopilotKit browser — setDashboardFocus, openReportCanvas, report section tools, renderAnalysisSummary):",
  "These execute in the client; session context JSON is the source of truth for canvas and dashboard state.",
  "REPORT CANVAS / DASHBOARD:",
